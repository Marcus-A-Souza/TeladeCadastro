...
namespace TeladeCadastro.Controllers
{
    public class CadastrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,cpf,email,idade,faixa")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,cpf,email,idade,faixa")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
